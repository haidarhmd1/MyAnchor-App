  ...
  return (
    ...
    >
      <div className="mb-3 flex justify-center">
        <Card
          className={cn(
            "w-full cursor-pointer rounded-4xl border-red-50 bg-red-50 px-2 py-4 transition-all duration-300 hover:border-red-600 hover:bg-red-100 hover:shadow-lg active:scale-[0.99]",
          )}
        >
