  ...
  return (
    <Sheet>
      ...
      <SheetContent side="bottom" className="h-11/12 overflow-auto">
        <SheetHeader>
          <SheetTitle className="mt-4">Physical Anchor</SheetTitle>
          <div className="space-y-8">
            <section>
              <h2 className="my-4">What it means?</h2>
              <p>
                A physical anchor is any tangible object you focus on with your
                senses to pull yourself back into the present moment. When
                anxiety or panic spirals, your mind feels detached or
            ...
            <section>
              ...
              <div className="space-y-3">
                <p>
                  Pick an object near you. (Example: a pen, a stone, your phone,
                  keys, a cup, a chair edge.)
                </p>
                ...
                <p>
                  Touch it slowly. Feel the temperature, weight, texture, edges.
                  Run your fingers across it.
                </p>

                <p>
                  Name what you notice out loud or in your mind. Example: “This
                  pen is smooth. It feels cool. It has black ink. It’s solid in
                  my hand.”
                </p>
            ...
            <section>
              ...
              <div className="space-y-3">
                ...
                <p>
                  Reassures your body — the solidity of an object contrasts the
                  “unreal” feeling of panic.
                </p>

                <p>
                  Engages multiple senses (sight, touch, sometimes even smell),
