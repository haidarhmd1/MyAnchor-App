...
type NavLinkProps = {
  href: "/" | "/education" | "/exercises" | "/exposure";
  label: string;
  icon: LucideIcon;
...
export const BottomNav = () => {
  return (
    <nav
      className="sticky bottom-0 z-50 grid h-16 w-full grid-cols-4 border-t bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80"
      aria-label="Primary"
    >
