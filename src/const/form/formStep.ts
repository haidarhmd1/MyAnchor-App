...
export const anxietyLevelOptions: {
  id: string;
  label: string;
  description: string;
  difficulty?: "easy" | "medium" | "hard";
...
export const stopReasonsOptions: {
  id: string;
  label: string;
  description: string;
  isCustom?: boolean;
  ...
  },
  {
    ...
    description: "Relied on phone, water, or checking body instead of staying",
  },
  {
    id: "panic_peak",
...
export const afterAttackActionsOptions: {
  id: string;
  label: string;
  description: string;
  isCustom?: boolean;
  ...
  // Custom option
  {
    id: "custom_action",
    label: "Custom action",
    description: "Write your own action after the attack",
    isCustom: true,
  },
];

export const exposureRatingOptions: {
  id: string;
  label: string;
  description: string;
}[] = [
  ...
  { id: "3", label: "3", description: "Mild challenge but stayed comfortable" },
...
export const keptGoingReasonsOptions: {
  id: string;
  label: string;
  description: string;
  isCustom?: boolean;
...
export const skippedChallengeReasonsOptions: {
  id: string;
  label: string;
  description: string;
  isCustom?: boolean;
